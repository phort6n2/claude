...
export default function MasterLeadsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 overflow-x-hidden">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">
                  {selectedClient?.businessName || 'Master Leads'}
                </h1>
      ...
      {/* Client Selector */}
      <div className="bg-white border-b sticky top-[57px] z-35">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-10 py-3 border-2 border-gray-200 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none text-gray-900 font-medium appearance-none"
            >
      ...
      {selectedClientId ? (
        <>
          {/* Date Navigation */}
          <div className="bg-white border-b sticky top-[121px] z-30">
            <div className="max-w-6xl mx-auto px-4 py-3">
