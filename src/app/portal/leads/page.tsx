        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h1 className="text-lg font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">{session.user?.businessName}</h1>
                <p className="text-xs text-gray-500 font-medium">Lead Portal</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <NotificationToggle />
              <Button variant="outline" size="sm" onClick={handleLogout} className="rounded-xl border-gray-200 hover:border-gray-300 hover:bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 rounded-xl transition-all min-w-[180px] justify-center text-gray-900 border border-blue-100"
            >
              <Calendar className="h-4 w-4 text-blue-600" />
              <span className="font-semibold">{formatDateDisplay(selectedDate)}</span>
              <ChevronDown className={`h-4 w-4 text-blue-600 transition-transform ${showCalendar ? 'rotate-180' : ''}`} />
            </button>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl p-10 text-center shadow-sm border border-gray-100">
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl text-sm font-medium hover:from-blue-700 hover:to-indigo-700 transition-all shadow-sm"
            >
              Go to today
            </button>
          </div>
  ...
  return (
    <button
      ...
      className={`bg-white rounded-2xl p-4 text-left shadow-sm hover:shadow-lg transition-all duration-200 w-full border-2 hover:scale-[1.02] ${
        isPhoneLead ? 'border-orange-300 bg-gradient-to-br from-orange-50/50 to-white' : 'border-gray-100 hover:border-blue-200'
      }`}
    >
      {/* Source & Status Badge */}
