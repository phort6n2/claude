      ...
      {approved ? (
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-gray-500">
            {kind === 'EXISTING'
              ? 'Updates the record we already hold, plus their alert recipients. Nothing is emailed to the shop — you send the portal invite from the client page when setup is done.'
              : 'Creates the client as ONBOARDING — photos, logo and ads wiring still come after this. Nothing is emailed to the shop — you send the portal invite from the client page when setup is done.'}
          </span>
        </div>
      )}
    </div>
